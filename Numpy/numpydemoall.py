...
print(c)
#slicing of rows and columns - row 1 and 2 and column 2 and 3
print(c[1:3,2:4])
print(c[1,-1])
...
#by default datatype of a and b is int but can be changed to float
...
#to search the value- GIVE US THE POSN
...
plt.pie(avmks,labels=names,explode=(0,0.2,0),startangle=90)
plt.bar(names,avmks)
